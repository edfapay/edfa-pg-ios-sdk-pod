...
#ifndef EDFAPAYMENTGATEWAY_SWIFT_H
#define EDFAPAYMENTGATEWAY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="EdfaPaymentGateway",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18EdfaPaymentGateway11AKMaskField")
...
@interface AKMaskField (SWIFT_EXTENSION(EdfaPaymentGateway)) <UITextFieldDelegate>
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC18EdfaPaymentGateway18CreditCardFormView")
...
SWIFT_CLASS("_TtC18EdfaPaymentGateway19SaleRedirectionView")
...
@interface SaleRedirectionView (SWIFT_EXTENSION(EdfaPaymentGateway)) <WKUIDelegate>
@end
...
@interface SaleRedirectionView (SWIFT_EXTENSION(EdfaPaymentGateway)) <WKNavigationDelegate>
...
SWIFT_CLASS("_TtC18EdfaPaymentGateway24TextFieldInputController")
...
SWIFT_CLASS("_TtC18EdfaPaymentGateway29TextFieldStartInputController")
...
SWIFT_CLASS("_TtC18EdfaPaymentGateway23TextViewInputController")
