...
public struct EdfaPgSale3ds: DetailsEdfaPgResultProtocol {
...
extension EdfaPgSale3ds: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        redirectParams = try container.decode(EdfaPgSaleRedirectParams.self, forKey: .redirectParams)
